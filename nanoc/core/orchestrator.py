...
class Orchestrator:
    ...
    def add_agent(self, agent: BaseAgent):
        ...
        # Also map by role for generic assignments, but agent_id takes precedence
        if agent.role not in self.agents:
            self.agents[agent.role] = agent

    def export_n8n_workflow(self):
        """Export current logic as n8n workflow JSON."""
        # This is already saved to nanoc/tools/n8n_workflow.json in this PR
        pass
