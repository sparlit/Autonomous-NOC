...
def main():
    ...
    # Initial bulk injection for 100 iterations as requested
    print("Performing initial bulk injection of 100 maintainer tasks...")
    for i in range(100):
        timestamp = int(time.time())
        filename = f"{inbox_dir}/maintainer_task_init_{timestamp}_{i}.txt"
