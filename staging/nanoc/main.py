...
def inbox_watcher():
    ...
    while True:
        ...
        for f in files:
            ...
            # More robust check for project complexity: multi-line or contains 'Step'
            is_complex = "\n" in project_desc.strip() or "step" in project_desc.lower()

            if is_complex:
                # Use PM for complex multi-step tasks
