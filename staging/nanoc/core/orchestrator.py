    ...
    async def run_loop(self):
        ...
        async def handle_gate_resolved(payload):
            ...
            if gate_type == "design":
                ...
                # When code gate passes, apply changes to production if they were verified
                await analyst.log(f"Project {project_id} code gate resolved. Promoting changes...")
                ...
                try:
                    ...
                    await analyst.log(f"Project {project_id} successfully promoted to production.")
                except Exception as e:
                    await analyst.log(f"Failed to promote project {project_id}: {e}")
